...
Fortunately for everybody, no one needs to know all of the above and we may find all of the above in a few lines of R:
...
That's right! We can summarise all the previous section in just one line of code. We will notice that actually find the same coefficients, the same values of $\beta$.
...
# These are the probability cut-offs that reach the maximum correct percentage.
